...
mx ${BASES_ISOS_PATH}/artigos lw=9999 "pft=(v880[1],'|',v12/)" now > article_titles.seq
tar cvfzp article_titles.seq.tgz article_titles.seq

mx ${BASES_ISOS_PATH}/artigos lw=9999 "pft=(v880[1],'|',v83/)" now > abstracts.seq
tar cvfzp abstracts.seq.tgz abstracts.seq

mx ${BASES_ISOS_PATH}/artigos lw=9999 "pft=(v880[1],'|',v85/)" now > keywords.seq
